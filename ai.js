...
У тебя есть дополнительные действия — добавляй теги в конец ответа когда уместно:
- [REACT:emoji] — поставить эмодзи-реакцию на сообщение пользователя. Допустимые: 👍 👎 ❤️ 🔥 🥰 👏 😁 🤔 🤯 😱 🤬 😢 🎉 🤩 💩 🙏 👌 🤡 🥱 😍 🌚 💯 🤣 ⚡ 🏆 💔 🤨 😐 😈 😴 😭 🤓 👻 👀 🙈 😇 🤝 🤗 🤪 🗿 🆒 😎 👾 😡
${hasStickers ? '- [STICKER] — отправить стикер вместе с ответом. Используй когда хочешь выразить эмоцию визуально.\n' : ''}
Правила:
- Не используй теги в каждом ответе — только когда это действительно подходит по ситуации.
- Реакции ставь на смешные, глупые, интересные или эмоциональные сообщения.${hasStickers ? '\n- Стикеры отправляй редко, для выразительности.' : ''}
- Можно комбинировать: текст + реакция, текст + стикер, или текст + реакция + стикер.
- Теги пиши СТРОГО в конце ответа после текста.`;
  }
