...
${hasStickers ? '- [STICKER] — отправить стикер из коллекции.\n' : ''}
Примеры ответов:
...
Если просят стикер — ОБЯЗАТЕЛЬНО добавь [STICKER]. Если хочешь отреагировать — добавь [REACT:emoji]. Не описывай отправку стикера словами, просто ставь тег.`;
  }
